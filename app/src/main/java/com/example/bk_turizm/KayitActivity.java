...
public class KayitActivity extends AppCompatActivity {
    ...
    private String isim,soyisim,telefon,mail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isim =inputFirstName.getText().toString();
        soyisim =inputLastName.getText().toString();
    ...
    public Dialog kayıtBaşarılıDiyalog() {
